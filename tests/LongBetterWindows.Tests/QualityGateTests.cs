...
public class QualityGateTests
{
    ...
    public void Host_ExplicitlyEnablesPerMonitorV2()
    {
        ...
        Assert.Contains("<Version>1.11.0-rc.17</Version>", project);
    ...
    {
        const string version = "1.11.0-rc.17";
        var project = Read("src", "LongBetterWindows.Host", "LongBetterWindows.Host.csproj");
    ...
    public void DesktopUiSmoke_HasStableAutomationEntryPoints()
    {
        ...
        Assert.Contains("StartAutomationEventCapture", script);
        Assert.Contains("LiveRegionChangedEvent", script);
        Assert.Contains("Long.CommandPalette.SelectionAnnouncement", script);
        Assert.Contains("focus_event_count", script);
        Assert.Contains("live_region_event_count", script);
        Assert.Contains("physical_keyboard_validated = $true", script);
