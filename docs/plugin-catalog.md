...
| 截图工具 | `com.long.screenshot` | `1.2.0` | `local` | `native` | `design` | `system.clipboard`, `system.hotkey`, `system.notification`, `system.screenshot` | [manifest.json](../src/ScreenshotPlugin/manifest.json) |
