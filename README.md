...
当前主线开发目标为 **v1.10.0**（尚未冻结），包含 27 个宿主能力接口、25 个内置插件，以及统一命令中心、超级面板、可信插件市场、命令参数 Schema 和宿主国际化。历史测试候选 `v1.9.0-rc.1` 继续保持不可变。当前开发状态见 [`docs/当前开发状态.md`](docs/当前开发状态.md)。
